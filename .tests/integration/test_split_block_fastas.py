...
RULE_NAME = "split_block_fastas"

TEST_CASES = [
    {
        "case_name": "case_basic",
        "target": "results/.work/block_fastas/per_block",
    },
]
...
def test_split_block_fastas_cases(
    tmp_path: Path,
    repo_root: Path,
    ...
    """Run integration tests for the split_block_fastas rule."""
    ...
    compare_directories(
        ...
        ignore_names={"all_blocks.raw.fasta"}
    )
