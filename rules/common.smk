...
AGGREGATION_DIR = OUTDIR / "20_aggregation"
LOG_DIR = OUTDIR / "logs"
...
KASP_SUMMARY_TSV = AGGREGATION_DIR / "kasp_summary.tsv"
DIAGNOSTIC_SNPS_VCF = FILTERED_SNP_DIR / "diagnostic_snps.vcf"
VALIDATED_SNPS_VCF = VALIDATION_DIR / "validated_snps.vcf"
ASSAY_SUMMARY_TSV = OUTDIR / "assay_summary.tsv"
VALIDATED_ASSAYS_TSV = OUTDIR / "validated_assays.tsv"
